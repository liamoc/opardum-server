...
> import Haskellpad.ClientRegistry
...
> updateSnapshot op doc = do debug $ "updating " ++ show doc ++ " with " ++ show op
>                            evaluate (Just $ doc +> op) `catch` 
>                              \(PatternMatchFail _) -> return Nothing
