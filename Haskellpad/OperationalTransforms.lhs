...
Haskellpad makes use of a type of patch calculus that is also used in other collaborative editors
...
$o$. Similarly, |[]| applied to any operation $o'$ is just $o'$.
...
But, suppose that the server had already recieved the following op, that inserted the word ``Quo'':
